                ...
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3">
                            <div class="logo">
                                <a href="{{route('frontend.home')}}"><img src="{{asset('frontend/assets/img/logo/logo.png')}}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="blog_left_sidebar">
                    ...
                    <article class="blog_item">
                        <div class="blog_item_img">
                            <img class="card-img rounded-0" src="{{asset('images/article/'.$article->image)}}" alt="">
                        </div>
                        ...
                        <div class="blog_details">
                            ...
                            <ul class="blog-info-link">
                                <li><a href="#"><i class="fa fa-list"></i> Category Name : {{$article->category->name}}</a></li>


                            </ul>
                            @foreach($article->tags as $tag)
                            <ul class="blog-info-link">
                                <li><a href="#"><i class="fa fa-list">   Tags Name :{{$tag->name}}</i></a></li>

                            </ul>
                            @endforeach
                        </div>
                        <a class="btn btn-primary" href="{{route('article',[$article->id])}}">Read More...
                ...
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="media post_item">
                            <img width="80px" height="80px" src="{{asset('images/article/'.$article->image)}}" alt="post">
